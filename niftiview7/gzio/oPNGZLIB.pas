...
uses zdeflate,zinflate,infblock,inftrees,infcodes,infutil,inffast,trees,adler_32;
...
function deflateInit_(var strm: TZStreamRec; level: Integer; version: PChar;
 ...
 function DeflateInit2_(var stream: TZStreamRec; level, method, windowBits,
   memLevel, strategy: Integer;version: PChar;
  recsize: Integer): Integer;external;


 function InflateInit2_(var stream: TZStreamRec; windowBits: Integer;version: PChar;
  recsize: Integer): Integer;external;
...
(*function gzopen (path:string; mode:string; flags:longint) : gzFile;
var
