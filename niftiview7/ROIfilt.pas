...
uses
  ...
  StdCtrls, RXSpin, Buttons,define_types, Mask,nifti_hdr, nifti_types;
...
type
  TFilterROIform = class(TForm)
    ...
    FiltROILabel: TLabel;
    MinROIfilt: TRxSpinEdit;
    MaxROIfilt: TRxSpinEdit;
